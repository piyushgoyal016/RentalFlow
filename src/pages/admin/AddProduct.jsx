  ...
  return (
    <div className="space-y-6 animate-fade-in-up max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-100 light:text-slate-800">Add New Product</h2>
          <p className="text-slate-500 text-sm mt-1">Insert a new item to the inventory catalog.</p>
        </div>
      </div>
